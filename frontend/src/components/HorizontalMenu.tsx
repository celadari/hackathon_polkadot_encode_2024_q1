...
const HorizontalMenu = ({ handleSelectNetworkUrlAndAccount }: Props) => {
    ...
    return (
        <nav className="flex items-center justify-end gap-4 bg-gray-800 text-white p-4">
            ...
            <div className="flex items-center min-w-[500px]">
                ...
                {isMounted ? (
                    <Select
                        ...
                        onChange={e => {
                            if (e?.value) {setAccountSelected(e.value)}
                        }}
            ...
            <div>
                <button disabled={!accountSelected}
                    onClick={() => handleSelectNetworkUrlAndAccount(networkUrl, accountSelected as InjectedAccount)}
